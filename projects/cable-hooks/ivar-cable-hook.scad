...
include<../ikea/ivar/ivar-dimensions.scad>

ivar_cable_holder_h = 3;

module ivar_velcro_cabel_holder(
    wt = 2,
    velcro_width = 13,
    ...
    velcro_interface_lenght = 5)
{
    ...
    _x = ivar_leg_w;//2*velcro_interface_lenght + _hd + 2*wt;

    difference()
    {
        union()
        {
            cubepp( [_x,_y,ivar_cable_holder_h],
                    align="z",
            ...
            intersection()
            {
                ...
                mirrorpp([1,0,0], true)
                    translate([_x/4,0,0])
                        mirrorpp([1,0,0], true)
                            translate([_hd/2-velcro_wt+0.5,0,ivar_cable_holder_h])
                            {
                ...
                cubepp( [_x,_y, ivar_cable_holder_h+_vz],
                    align="z",
                    mod_list=[round_edges(r=wt, axes="xy")]);
            }
        ...
        // screw hole
        mirrorpp([1,0,0], true)
        translate([_x/4,0,ivar_cable_holder_h])
            screw_hole(
                standard=cable_holder_screw_standard,
                descriptor=cable_holder_screw_descriptor,
                align="t",
