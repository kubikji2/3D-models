...
module right_wing(d=2)
{

    difference()
    {
        translate([-256,-125,0]) resize([220,70,3]) import("import/SCALED_right_wing.stl");
        ...
        translate([-10,0,1]) cube([10,70,10]);
    }

    difference()
    {
        translate([-10-2,1,1]) cube([2,60,10]);
        ...
        translate([-10,25+1,7]) rotate([0,90,0]) cylinder(h=10,d=d, center=true);
