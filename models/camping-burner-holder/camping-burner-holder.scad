...
module arm_interface(   angle,
                        clearance, 
                        bolt_clearance,
                        is_arm=false)
{
    clrn = clearance;
    b_clrn = is_undef(bolt_clearance) ? clearance : bolt_clearance;
            ...
            clearance)
{
    ...
    translate(a2i)
        arm_interface(0, clearance=clearance, is_arm=true);
}
